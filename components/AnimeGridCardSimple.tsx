...
export default function AnimeGridCardSimple({ anime, onPress, index }: AnimeGridCardProps) {
  // Animation values
...
const styles = StyleSheet.create({
  ...
  progressFill: {
    height: '100%',
    backgroundColor: undefined, // use bg-primary via className where possible
    borderRadius: 1.5,
  },
  actionButtons: {
    position: 'absolute',
