...
export default function CreateEvent() {
  ...
  const submit = () => {
    // Minimal creation: navigate back to events list
    ...
    <SafeAreaView className="flex-1" style={{ backgroundColor: '#071026' }}>
      <LinearGradient colors={["#071026", "transparent"]} className="pt-2">
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 12, paddingVertical: 10 }}>
          ...
          <TouchableOpacity onPress={submit} style={{ paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8, backgroundColor: title ? '#1e90ff' : 'rgba(255,255,255,0.04)' }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 12 }}>
        ...
        <TouchableOpacity onPress={submit} style={{ backgroundColor: '#1e90ff', padding: 14, borderRadius: 12, alignItems: 'center' }}>
          <Text style={{ color: '#fff', fontWeight: '700' }}>Créer l'événement</Text>
        </TouchableOpacity>
      </ScrollView>
    </SafeAreaView>
  );
